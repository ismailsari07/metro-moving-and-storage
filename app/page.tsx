  ...
  return (
    <main className="">
        ...
        >
          <div className="md:w-3/4 md:absolute md:top-1/2 md:left-1/2 md:-translate-y-1/2 md:-translate-x-1/2 flex flex-col md:flex-row justify-between items-center md:gap-20 z-10">
            ...
            <div className="md:w-3/5 flex flex-col items-center md:items-start gap-3 md:gap-6 max-md:p-2 max-md:my-6 max-md:text-center">
              <motion.span
                variants={item}
                className="px-3 rounded-2xl bg-blue-600 text-xs md:text-sm md:font-semibold"
              >
                🏆 Trusted Moving Professionals
              </motion.span>
              <motion.h1
                variants={item}
                className="text-3xl md:text-6xl font-semibold text-gray-800 md:text-white"
              >
                Stress-Free, Reliable{" "}
                <span className="text-blue-400"> Moving Services</span>
              </motion.h1>
              <motion.p
                variants={item}
                className="text-lg text-gray-800 md:text-white"
              >
                Experience seamless moving with our professional team. From
                residential moves to commercial relocations, we handle your
                belongings with care and precision.
              </motion.p>
            </div>
          ...
          <img
            src={"/truck-highway-sunset.jpg"}
            alt="truck image"
            className="max-md:hidden relative max-h-[800px] w-[95%] md:w-full brightness-50 max-md:mt-6 max-md:rounded-xl max-md:mx-auto"
          />
          {/* Mobile Version */}
          <motion.img
            variants={item}
            src={"/truck-highway-sunset.jpg"}
            alt="truck image"
            className="md:hidden relative max-h-[800px] w-[95%] md:w-full brightness-50 max-md:mt-6 max-md:rounded-xl max-md:mx-auto"
          />
        </motion.header>
      </div>
      ...
      <section className="flex flex-col items-center justify-center gap-10 py-16 md:py-32 px-2 md:px-10">
        <div>
          ...
          >
            ...
            >
              Cross-Border Moving Expertise
            </motion.h3>
            <motion.p
              variants={item}
              className="text-lg text-gray-600 md:w-1/2"
            >
              Moving between Canada and the US involves complex regulations,
              documentation, and logistics. Our specialized knowledge ensures
              your international move is handled with precision and care.
            </motion.p>
          </motion.div>
              ...
              <div className="bg-red-100 flex justify-center items-center gap-5 p-5 rounded-t-2xl">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-500">
                    Seamless relocations from any Canadian province to US states
                  </p>
                </div>
              </div>
              ...
              <div className="p-5 flex flex-col gap-3">
                <div className="flex items-start gap-4 text-start">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700">
                      Complete assistance with visa requirements and customs
                      forms
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-4 text-start">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700">
                      Expert handling of customs duties and import regulations
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-4 text-start">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700">
                      Specialized car shipping with all required certifications
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-4 text-start">
            ...
            <div className="shadow-2xl md:w-1/2 rounded-2xl">
              <div className="bg-blue-100 flex justify-center items-center gap-5 p-5 rounded-t-2xl">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-500">
                    Professional moves from US states to Canadian provinces
                  </p>
                </div>
              </div>
              ...
              <div className="p-5 flex flex-col gap-3">
                <div className="flex items-start gap-4 text-start">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700">
                      Guidance through Canadian immigration procedures
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-4 text-start">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700">
                      Full compliance with Canada Border Services Agency
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-4 text-start">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700">
                      Expert knowledge of provincial moving requirements
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-4 text-start">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700">
                      Information on healthcare system transitions
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="bg-[#f9fafb] flex flex-col items-center justify-center gap-10 py-16 md:py-36 px-2 md:px-10">
        ...
        <p className="text-lg text-gray-700 text-center md:mb-10">
          Our comprehensive 5-step process ensures your move is handled with
          professional care <br /> and attention to every detail, from initial
          planning to settling into your new space.
        </p>
        ...
        <div className="w-full bg-blue-700 text-white flex flex-col items-center gap-3 md:gap-6 p-3 md:p-8 rounded-2xl text-center">
          ...
          <p>
            Our proven 5-step method has successfully moved over 15,000 families
            and businesses. <br /> Let us make your next move the smoothest one
            yet.
          </p>
      ...
      <section className="flex flex-col items-center justify-center gap-10 pb-36 px-2 md:px-10">
        ...
        <p className="text-lg text-gray-700 text-center md:mb-10">
          Real experiences from satisfied customers who trusted us with their
          moves
        </p>
        ...
        <div className="w-full flex flex-col md:flex-row gap-5 justify-center">
          <div className="shadow-xl p-4 md:p-8 rounded-2xl flex flex-col items-start gap-5 w-full md:w-[30%]">
            ...
            <p className="italic gray-700">
              "Metro Moving made our cross-country move seamless. The team was
              professional, efficient, and took great care of our belongings.
              Highly recommended!"
            </p>
          ...
          <div className="shadow-xl p-4 md:p-8 rounded-2xl flex flex-col items-start gap-5 w-full md:w-[30%]">
            ...
            <p className="italic gray-700">
              "Stored our furniture for 3 months during our move from Vancouver
              to Dallas. Everything was in perfect condition and the storage
              facility was incredibly secure!"
            </p>
            <div className="flex gap-3 items-center">
              <div className="bg-blue-300 rounded-full px-5 py-3 font-bold">
                J
              ...
              <div>
                <div className="text-lg font-semibold text-black">
                  Jennifer Martinez (Alberta, Calgary)
                </div>
          ...
          <div className="shadow-xl p-4 md:p-8 rounded-2xl flex flex-col items-start gap-5 w-full md:w-[30%]">
            ...
            <p className="italic gray-700">
              "Excellent service for our office relocation. They completed the
              move over the weekend with zero disruption to our business
      ...
      <section className="bg-blue-700 flex flex-col items-center justify-center gap-5 py-36 px-2 md:px-10 text-white">
        <h3 className="text-4xl font-bold text-center">
          Why Choose Metro Moving?
        </h3>
        <p className="text-lg text-gray-200 text-center md:mb-10">
          We're committed to providing exceptional moving services that{" "}
          <br className="max-md:hidden" /> exceed your expectations
        </p>
        ...
        <div className="md:w-2/3 flex flex-col md:flex-row gap-5 justify-center max-md:mt-10">
          ...
          <div className="w-full md:w-1/3 flex flex-col justify-center items-center gap-3">
            <div className="p-5 rounded-full bg-blue-800">
              {" "}
              <ShieldIcon size={"24"} />{" "}
            </div>
            <div className="text-lg font-semibold">Licensed & Insured</div>
            <div className="text-gray-200 text-center">
              Fully licensed and insured for your peace of mind. Your belongings
          ...
          <div className="w-full md:w-1/3 flex flex-col justify-center items-center gap-3">
            ...
            <div className="text-gray-200 text-center">
              Competitive pricing without compromising on quality. No hidden
              fees, just transparent and fair pricing.
            </div>
          </div>
          ...
          <div className="w-full md:w-1/3 flex flex-col justify-center items-center gap-3">
            ...
            <div className="text-gray-200 text-center">
              Local, long-distance, and cross-country moves. We go wherever you
              need to go.
            </div>
          </div>
        </div>
