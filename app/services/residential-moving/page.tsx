...
export default function Page() {
  return (
    <div className="">
      <div className="bg-blue-100 flex flex-col items-center gap-5 lg:text-center py-10 md:py-20 max-md:text-center max-md:px-2">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-5 py-10 md:py-28 px-2 md:px-40">
        ...
        <img src={"/residential-moving.jpg"} className="rounded-xl w-2xl max-md:order-1" />
      </div>
