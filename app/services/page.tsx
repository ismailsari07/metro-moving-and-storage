...
import { CircleCheckBigIcon, ClockIcon, HomeIcon, ShoppingBag, ShoppingBagIcon, StoreIcon } from "lucide-react";
  ...
  return (
    <>
      <div className="bg-[#e5e4ff] flex flex-col items-center gap-5 lg:text-center py-20">
        ...
        <p className="text-lg text-gray-500">From cross-border delivery to full-service moving and secure storage, we provide <br /> comprehensive solutions for all your logistics needs.</p>
      </div>

      <div className="flex flex-col gap-5 lg:text-center py-28">
        ...
        <div className="w-full flex gap-5 justify-center">
          ...
          {/* Service 1 */}
          <div className="p-8 border-2 border-gray-300 rounded-xl shadow-xl">
